...
import { rules } from '@/utils/appmanagement/role/form';
import { useLoadingForm } from '@/utils/loading';
import { emitsGlobal, propsForm } from '@/utils/props';
import useVuelidate from '@vuelidate/core';
import { add, detail, update } from '@/service/AppManagement/role';
import type { IResponseRole, IRequestRole } from '@/model/role-interface';
...
// data
const state = reactive<IRequestRole>({
  name: '',
});
